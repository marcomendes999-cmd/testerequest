...
@section('content')
    <div class="container mx-auto p-4">
        <div class="flex justify-between items-center mb-6">
            ...
            <a href="{{ route('users.create') }}" class="px-6 py-2 bg-blue-600 text-white rounded-lg shadow-lg hover:bg-blue-700 transition duration-300 transform hover:scale-105">
                    ...
                    <tbody class="text-gray-600 text-sm font-light">
                        @foreach($users as $user)
                            <tr class="border-b border-gray-200 hover:bg-gray-50">
                                ...
                                <td class="py-3 px-6 text-left">
                                    <span class="font-medium text-gray-700 capitalize">{{ $user->tipo }}</span>
                                </td>
                                <td class="py-3 px-6 text-left">
                                    <span class="font-medium text-gray-700 capitalize"> {{ $user->empresa->nome ?? 'N/A' }}</span>
                                </td>
